...
// Function to calculate the coin's age in a user-friendly format
...
// Fetch data for a specific address and cache it
...
// Retrieve data for multiple addresses, utilizing cache when available
...
export default async function handler(req, res) {
    ...
    if (req.method === "GET") {
        try {
            ...
            else if (!isPromoted) query.blockchain = "tron";
