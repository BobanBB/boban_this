...
export default async function handler(req, res) {
    ...
    if (req.method === "GET") {
        try {
            ...
            // Create the query and apply promoted filtering if needed
            const query = { blockchain: "ETH" };
            ...
            // Fetch coins based on the pagination query
            ...
            // Fetch data for each coin's contract address
            ...
            // Sort coins by trending data (1-hour percent change)
